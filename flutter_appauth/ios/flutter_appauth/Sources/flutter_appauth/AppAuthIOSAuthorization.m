                  ...
                  externalUserAgent:agent
                           callback:^(OIDAuthorizationResponse
                             ...
                             if (authorizationResponse) {
                                ...
                                if (authorizationResponse.additionalParameters != nil) {
                                    [processedResponse setObject:authorizationResponse.additionalParameters
                                                        forKey:@"authorizationAdditionalParameters"];
                                }

                                NSLog(@"authorizationCode = %@", authorizationResponse.authorizationCode);
                                NSLog(@"additionalParameters = %@", authorizationResponse.additionalParameters);

                                if (authorizationResponse.authorizationCode != nil) {
                                    [processedResponse setObject:authorizationResponse.authorizationCode
                                                        forKey:@"authorizationCode"];
                                }

                                if (authorizationResponse.request.codeVerifier != nil) {
                                    [processedResponse setObject:authorizationResponse.request.codeVerifier
                                                        forKey:@"codeVerifier"];
                                }

                                if (authorizationResponse.request.nonce != nil) {
                                    [processedResponse setObject:authorizationResponse.request.nonce
                                                        forKey:@"nonce"];
                                }
