...
import 'package:muzhiki_dependencies/service/session/extension/roles_company.dart';
import 'package:muzhiki_dependencies/service/session/model/session_roles.dart';
import 'package:muzhiki_dependencies/service/session/model/user.dart';
      ...
      if (code != null && codeVerifier != null) {
        try {
          ...
          if (roles != null) {
            ...
            if (!hasSavedCompany) {
              selectedCompany = companies.isNotEmpty
                  ? companies.first.id
                  : null;
            }
          }
          ...
          Future.delayed(
            ...
            () => fresh.setToken(
              AuthTokens(accessToken: token, refreshToken: ""),
            ),
          );
