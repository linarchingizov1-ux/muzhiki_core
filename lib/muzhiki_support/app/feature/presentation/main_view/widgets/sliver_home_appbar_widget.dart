...
class SliverHomeAppbarWidget extends StatelessWidget {
  ...
  final ValueNotifier<bool> showChoi;
  final bool canPop;
      ...
      return SliverPadding(
        ...
        sliver: SliverAppBar(
          ...
          title: ValueListenableBuilder<bool>(
            valueListenable: showChoi,
            builder: (context, showChoi, _) {
...
class _ChoiAppBar extends StatelessWidget {
  final ChatCubit chatCubit;

  const _ChoiAppBar({super.key, required this.chatCubit});
