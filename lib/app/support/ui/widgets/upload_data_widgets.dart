...
// import 'package:mp_master_app/src/core/network/map_error.dart';
...
// import 'package:mp_master_app/src/features/widgets/interface/banner/app_banner_notifier.dart';
...
//   const UploadDataWidgets({super.key, required this.item});
...
//       widget.item.maybeWhen(remote: (_, __, data) => data, orElse: () => null);

//   bool get isLoading => widget.item.maybeWhen(
//     local: (_, __, ___, isLoading) => isLoading,
//     orElse: () => false,
//   );
...
//         local: (_, __, path, ___) => path,
//         remote: (_, __, data) => data.url,
//       );

//       fileName = VideoThumbnail.thumbnailFile(
//         video: videoPath,
//         thumbnailPath: getIt<Directory>().path,
...
//       setState(() {});
//     } catch (e, st) {
//       final error = AppErrorMapper.map(e, st);
//       AppBannerNotifier.I.show(error.message);
//     }
//   }
...
//                   widget.item.when(
//                     local: (id, _, __, ___) => id,
//                     remote: (id, _, __) => id,
//                   ),
//                 ),
//                 child: Icon(Icons.close, size: 16.r, color: AppColors.black1),
//               ),
//             ),
//             if (isLoading)
//               Positioned.fill(
