...
import 'package:muzhiki_core/app/support/websocket/data/model/message/new_message.dart';
...
class AppWebsocketChat extends WebSocketChat {
  ...
  final VoidCallback? pushOn;
  final VoidCallback? pushOff;
  ...
  Future<void> connect() async {
    ...
    try {
      ...
      await readMessage(sessionId: sessionId);
    } catch (e, st) {
  ...
  void _handleNewMessage(Map<String, dynamic> json) {
    ...
    unawaited(readMessage(sessionId: sessionId));
  }
